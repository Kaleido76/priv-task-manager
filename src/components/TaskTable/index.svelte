<script lang="ts">
  ...
  const columns: { key: string; label: string; width: string; align: string }[] = [
    ...
    { key: "progress", label: "Progress", width: "80px", align: "center" },
    { key: "deadline", label: "Deadline", width: "110px", align: "right" },
    { key: "__deadline_help", label: "", width: "100px", align: "center" },
  ];
